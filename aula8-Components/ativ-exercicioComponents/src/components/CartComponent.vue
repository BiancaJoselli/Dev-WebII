<script setup>
defineProps(['cart'])
defineEmits(['hide-cart', 'incremente-book', 'decremente-book'])
</script>
                ...
                <tr v-for="book in cart.items" :key="book.id">
                    ...
                    <td>
                        <div class="cart-item-quantity">
                            <button @click="$emit('decremente-book', book)" class="plain">
                                <span class="mdi mdi-minus" />
                            </button>
                            {{ book.quantity }}
                            <button @click="$emit('incremente-book', book)" class="plain">
